# Refactored from https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
...
class ResNet(nn.Module):
    ...
    def __init__(self, arch, repeats, from_small=False, num_classes=100, zero_init_residual=False,
                 groups=1, width_per_group=64, norm_layer=None):
        super(ResNet, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._from_small = from_small
