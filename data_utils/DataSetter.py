...
# image sizes
image_size = {'cifar10': 32, 'cifar100': 32, 'tiny-imagenet': 64}
image_num = {'cifar10': 50000, 'cifar100': 50000, 'tiny-imagenet': 100000}
...
def data_loader(datasets, root, rep_augment=None, batch_size=128, 
    ...
    if rep_augment == 'simclr':
        rep_augment = simclr_transform(image_size[datasets], 1)
