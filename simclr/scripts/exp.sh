...
# pretrain encoder
python ./pretrain.py -a resnet18 --batch-size 256 --lr 0.3 --epochs 2 --dataset tiny-imagenet --data-path $data_path --temperature 0.5 --exp-name $exp_name --cos --multiprocessing-distributed --dist-url tcp://localhost:10021 --gpu 0 1 --wd 1e-6 --out-dim 128 --save-freq 1
