...
gpu=1
exp_name="mixco_gihun"

# pretrain encoder
python ./main.py -a resnet18 --builder mixco --batch-size 128 --lr 0.015 --epochs 100 --schedule 60 80 --gpu $gpu --dataset tiny-imagenet --data-path $data_path --mlp --moco-t 0.2 --aug-plus --cos --exp-name $exp_name
