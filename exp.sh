...
# pretrain encoder
python ./main.py -a resnet18 --builder mixco --lr 0.015 --epochs 150 --schedule 80 120 --gpu $gpu --dataset tiny-imagenet --data-path $data_path --mlp --moco-t 0.2 --aug-plus --cos --exp-name $exp_name
