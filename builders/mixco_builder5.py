...
class MixCo(nn.Module):
    ...
    def forward(self, im_q, im_k):
        ...
        q = self.encoder_q(imgs_mix)  # queries: (N/2)xC
        ...
        logits_mix_pos = torch.mm(q, k.transpose(0, 1)) 
        # mixed negative logits: N/2 x K
        logits_mix_neg = torch.mm(q, self.queue.clone().detach())
