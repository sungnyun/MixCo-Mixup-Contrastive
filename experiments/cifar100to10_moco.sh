...
python lincls.py -a resnet18 --lr 3.0 --epochs 100 --dataset cifar10 --data-path $data_path --pretrained ./results/pretrained/${exp_name}.pth.tar --exp-name $exp_name --multiprocessing-distributed --dist-url tcp://localhost:10002
