...
EXPERIMENT_PATH="./experiments/swav_resnet18_100ep_bs128_gpu2_lincls_cifar10"
mkdir -p $EXPERIMENT_PATH

python -u eval_linear.py \
--data_path $DATASET_PATH \
--dataset cifar10 \
--pretrained './experiments/swav_resnet18_100ep_bs128_gpu2_pretrain/checkpoint.pth.tar' \
--dist_url $dist_url \
--arch resnet18 \
--dump_path $EXPERIMENT_PATH \
--multiprocessing-distributed \
